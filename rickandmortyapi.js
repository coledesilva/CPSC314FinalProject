  ...
  request.onload = function() {
    ...
    for (i = 1; i <= 10; i++) {
      ...
      document.getElementById(text).innerHTML =
        "Character ID: " + data.results[i - 1].id;
      document.getElementById(item1).innerHTML =
        "First Appearance: Episode " +
        data.results[i - 1].episode[0].substring(40, 42);
      document.getElementById(item2).innerHTML =
        "Origin: " + data.results[i - 1].origin.name;
      document.getElementById(item3).innerHTML =
        "Gender: " + data.results[i - 1].gender;
      document.getElementById(item4).innerHTML =
        "Species: " + data.results[i - 1].species;
      document.getElementById(item5).innerHTML =
        "Status: " + data.results[i - 1].status;
    }
  };
...
function randomCards() {
  ...
  request.onload = function() {
    ...
    for (i = 1; i <= data.length; i++) {
      ...
      document.getElementById(text).innerHTML =
        "Character ID: " + data[i - 1].id;
      document.getElementById(item1).innerHTML =
        "First Appearance: Episode " + data[i - 1].episode[0].substring(40, 42);
      document.getElementById(item2).innerHTML =
        "Origin: " + data[i - 1].origin.name;
      document.getElementById(item3).innerHTML =
        "Gender: " + data[i - 1].gender;
      document.getElementById(item4).innerHTML =
        "Species: " + data[i - 1].species;
      document.getElementById(item5).innerHTML =
